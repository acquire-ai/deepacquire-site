  ...
  en: {
    ...
    pro: {
      ...
      items: [
        ...
        { description: 'AI Translation (based on credits, 1,800 credits ≈ 540 mins)' },
        { description: 'Subtitle Enhance (free during preview)' },
        { description: 'ASR Transcription (free during preview)' },
      ],
      cta: {
    ...
    max: {
      ...
      items: [
        ...
        { description: 'AI Translation (based on credits, 6,000 credits ≈ 1,800 mins)' },
        { description: 'Subtitle Enhance (free during preview)' },
        { description: 'ASR Transcription (free during preview)' },
      ],
      cta: {
    ...
    ultra: {
      ...
      items: [
        ...
        { description: 'AI Translation (based on credits, 15,000 credits ≈ 4,500 mins)' },
        { description: 'Subtitle Enhance (free during preview)' },
        { description: 'ASR Transcription (free during preview)' },
      ],
      cta: {
  ...
  'zh-CN': {
    ...
    pro: {
      ...
      items: [
        ...
        { description: 'AI 翻译（按积分计算， 9 倍免费用户）' },
        { description: '字幕增强（预览期间免费）' },
        { description: '语音识别转写（预览期间免费）' },
      ],
      cta: {
    ...
    max: {
      ...
      items: [
        ...
        { description: 'AI 翻译（按积分计算，3.3 倍 prod 用户）' },
        { description: '字幕增强（预览期间免费）' },
        { description: '语音识别转写（预览期间免费）' },
      ],
      cta: {
    ...
    ultra: {
      ...
      items: [
        ...
        { description: 'AI 翻译（按积分计算， 2.5 倍 max 用户）' },
        { description: '字幕增强（预览期间免费）' },
        { description: '语音识别转写（预览期间免费）' },
      ],
      cta: {
  ...
  'zh-TW': {
    ...
    pro: {
      ...
      items: [
        ...
        { description: 'AI 翻譯（按點數計算，1,800 點數約 540 分鐘）' },
        { description: '字幕強化（預覽期間免費）' },
        { description: '語音辨識轉寫（預覽期間免費）' },
      ],
      cta: {
    ...
    max: {
      ...
      items: [
        ...
        { description: 'AI 翻譯（按點數計算，6,000 點數約 1,800 分鐘）' },
        { description: '字幕強化（預覽期間免費）' },
        { description: '語音辨識轉寫（預覽期間免費）' },
      ],
      cta: {
    ...
    ultra: {
      ...
      items: [
        ...
        { description: 'AI 翻譯（按點數計算，15,000 點數約 4,500 分鐘）' },
        { description: '字幕強化（預覽期間免費）' },
        { description: '語音辨識轉寫（預覽期間免費）' },
      ],
      cta: {
